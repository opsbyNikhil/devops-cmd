    ...
    return (
      ...
      >
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            {(Object.keys(containerMeta) as ContainerKey[]).map((key) => {
              const m = containerMeta[key];
              return (
                <div
                  key={key}
                  className="ct-card"
        ...
        >
          ...
          >
            ...
            <div className="k8s-card-inner">
              ...
              <p className="k8s-card-desc" style={{ color: textDesc }}>
                Smallest deployable unit in Kubernetes. View YAML spec,
              ...
              >
                {["YAML Spec", "Lifecycle", "Networking"].map((tag) => (
                  <span
                    key={tag}
                    style={{
                      fontFamily: "'Space Mono', monospace",
          ...
          >
            ...
            <div className="k8s-card-inner">
              ...
              <p className="k8s-card-desc" style={{ color: textDesc }}>
                Main, Init & Sidecar container patterns. Explore runtime specs
                and use cases.
              </p>
